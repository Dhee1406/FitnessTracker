        ...
        </button>
      {
        showSignup ? (
            <div className='authform'>
                ...
                <div className='right'>
                    ...
                    <form action="">
                        ...
                        <Input color='warning' placeholder='password' size='lg' variant='solid'
                            onChange={(e) => {
                                setSignupFormData({
                                    ...signupformData,
                        ...
                        <Input color='warning' placeholder='Weight in kg' type='number' size='lg' variant='solid'
                            onChange={(e) => {
                                setSignupFormData({
                                    ...signupformData,
                        ...
                        <Input color='warning' placeholder='Weight in cm' type='number' size='lg' variant='solid'
                            onChange={(e) => {
                                setSignupFormData({
                                    ...signupformData,
            ...
            <div className='authform'>
                ...
                <div className='right'>
                    <h1>Login to show your freak</h1>
                    <form action="">
                        <Input color='warning' placeholder='email' size='lg' variant='solid'
                            onChange={(e) => {
                                setLoginFormData({
